...
// 脚本配置区域开始
// 共享课部分
var gxkEnable = true;  //共享课刷课主开关
var abnormalStuckDetectionEnable = true;  //异常卡顿检测开关
var abnormalStuckDetectionLimit = 10;  //异常卡顿等待秒数
var autoClosePopUpTest = true;  //自动关闭弹题开关
var pauseResume = true;  //暂停自动恢复开关
var autoMute = true;  //自动静音开关
var auto15x = true;  //自动 1.5 倍速开关
var autoBQ = true;  //自动切换标清开关
var autoPlayNext = true;  //自动切换下一集开关
var autoStop = false;  //达到时间自动停止开关
var autoStopTime = 30;  //若上一选项为 true，则达到此分钟数自动停止
